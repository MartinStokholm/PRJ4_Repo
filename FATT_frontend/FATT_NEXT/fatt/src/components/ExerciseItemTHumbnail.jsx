...
const ExerciseItemThumbnail = ({ exercise }) => {
  return (
    <div className="bg-white max-w-sm rounded overflow-hidden shadow-lg content-center h-200">
      <Link
        className="w-full block p-2 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-blue-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
